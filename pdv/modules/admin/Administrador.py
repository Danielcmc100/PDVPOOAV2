...
from modules.repositorios.RepositorioFornecedores import RepositorioFornecedores
from modules.repositorios.RepositorioClientesFiado import RepositorioClientesFiado
from modules.repositorios.RepositorioProdutos import RepositorioProdutos


class Administrador:
    def __init__(self, autenticador: Autenticador, gerenciador_de_relatorios:GerenciadorRelatorios, repositorio_de_clientes:RepositorioClientesFiado,repositorio_de_fornecedores:RepositorioFornecedores,repositorio_de_produtos:RepositorioProdutos,repositorio_de_despesas:RepositorioDespesas):
